// Provided by:   ____________Xing Yang__________
// Email Address: ____________xyang004@citymail.cuny.edu________
// FILE: sequence2.h
...
namespace main_savitch_4
{
    ...
    public:
        ...
        bool is_item( ) const {return sequence_current < used;}
        value_type current( ) const;
